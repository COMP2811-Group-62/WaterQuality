/****************************************************************************
** Meta object code from reading C++ file 'popspage.h'
**
...
#error "The header file 'popspage.h' doesn't include <QObject>."
...
void POPsPage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->updateDisplay((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
        case 1: _t->updateTimeRange((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
        case 2: _t->updateSafetyIndicator(); break;
        case 3: _t->handleExport(); break;
        default: ;
        }
    }
}
